				...
				switch( $action )
				{
					...
					case 'powerpress-multisite-save-site-settings': {
						...
						if( !empty($_POST['General']) )
						{
							...
							foreach($NewSettings as $index => $value)
							{
...
<p style="text-align: center;">
	<a href="<?php echo network_admin_url("sites.php?page=powerpress-multisite&amp;=$blog_id"); ?>" onclick="self.parent.tb_remove(); return false;" target="_top"><?php echo __('Close', 'powerpress'); ?></a>
</p>
